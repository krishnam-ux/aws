        ...
        <div className="grid gap-8 lg:grid-cols-[1.7fr_0.9fr]">
          ...
          <aside className="space-y-6">
            <div className="tech-card-new p-6">
              ...
              <div className="mt-6">
                {canApply ? (
                  <Link href={`/opportunities/${career.slug}/apply`} className="btn-primary w-full justify-center">Apply Now</Link>
                ) : (
            ...
            <div className="tech-card-new p-6">
              ...
              <div className="space-y-2">
                <Link href="/opportunities" className="block text-sm text-aws-blue hover:underline">← Back to opportunities</Link>
